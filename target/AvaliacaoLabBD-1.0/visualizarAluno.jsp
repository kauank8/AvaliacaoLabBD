...
<link rel="stylesheet" href="./css/visualizarAluno.css">
...
<body>
	...
	<ul>
		...
		<li><a href="visualizarAluno.jsp" class="ativa">Visualizar/Alterar Aluno</a>
		<li><a href="telefone.jsp">Telefone</a>
		<li><a href="matricula.jsp">Matricula</a>
		<li><a href="consultarMatricula.jsp">Consulta Matricula</a>
	</ul>
	</nav>
