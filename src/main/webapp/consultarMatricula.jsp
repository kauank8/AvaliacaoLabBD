...
<link rel="stylesheet" href="./css/consultarMatricula.css">
...
<body>
	...
	<ul>
		...
		<li><a href="secretaria.jsp" >Cadastrar Aluno</a>
		<li><a href="visualizarAluno.jsp" >Visualizar/Alterar Aluno</a>
		<li><a href="telefone.jsp">Telefone</a>
		<li><a href="matricula.jsp">Matricula</a>
		<li><a href="consultarMatricula.jsp"  class="ativa">Consulta Matricula</a>
	</ul>
	</nav>
